...
#ifndef LIBECL_CONTAINERS_CIRCULAR_BUFFER_H
#define LIBECL_CONTAINERS_CIRCULAR_BUFFER_H
 ...
 *
 * Limitations
 * - requires some form of locking, cannot be lock-free
 *
 * \todo Conversion to value_type
 * \todo noexcept?
 * \todo memory orders
 * \todo deconstructor clears the buffer
 */
